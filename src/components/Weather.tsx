            ...
            <div className="container">
                ...
                <div className="level" style={{alignItems: "flex-start"}}>
                    <div className="level-item has-text-centered">
                        <div>
                            <p className="heading">{data.weather[0].descirption}</p>
                            <p className="title"><img className='iconWeather' src={`http://openweathermap.org/img/wn/${data.weather[0].icon}@4x.png`} alt="icon" /></p>
                        </div>
                    </div>
                    <div className="level-item has-text-centered">
                        <div>
